...
import { NAlert, NButton, NTag, useMessage, NCard, NSkeleton } from 'naive-ui'; // 确保引入了所有 Naive UI 组件

// 关键修改：只导入 useGlobalState
...
const {
    userSettings, userJwt, userOpenSettings, removeJwt // <-- 这里现在可以正确解构 removeJwt
} = useGlobalState() 
